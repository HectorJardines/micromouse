...
void update_pid(void)
{
    ...
    l293d_dir_e right_motor_dir = right_motor_pwm < 0 ? dir_reverse : right_motor_pwm > 0 ? dir_forward : dir_stop;
    l293d_set_dir(l293d_motor_right, right_motor_dir);
    l293d_set_speed(l293d_motor_right, right_motor_pwm);

    l293d_dir_e left_motor_dir = left_motor_pwm < 0 ? dir_reverse : left_motor_pwm > 0 ? dir_forward : dir_stop;
    l293d_set_dir(l293d_motor_left, left_motor_dir);
    l293d_set_speed(l293d_motor_left, left_motor_pwm);
}
